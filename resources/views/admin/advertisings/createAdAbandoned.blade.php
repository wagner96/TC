...
<div class="container">
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4 inputGroupContainer">
                <div class="input-group">
                    ...
                    {{Form::text('name_pet','', array('placeholder' => 'Nome do animal','class' => 'form-control', 'required'))}}        </div>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4 inputGroupContainer">
                <div class="image-preview-input input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-picture"></i></span>
                    {{Form::file('photos', ['class' => 'form-control', 'accept'=>'image/png, image/jpeg, image/gif'])}}
                </div>
            </div>
        </div>
